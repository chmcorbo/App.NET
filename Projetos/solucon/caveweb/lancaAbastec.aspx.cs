...
{
    public partial class AbastecOnline : System.Web.UI.Page, IPaginaCadPadrao
    {
        ...
        protected void ibtGravar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                Response.Redirect("lancaAbastec.aspx");
        ...
        protected void ibtFuncionario_Click(object sender, ImageClickEventArgs e)
        {
            Session["POPUP_URL"] = "BuscaFunc.aspx";
        }
    }
}
