<%@ Page Title="" Language="C#" MasterPageFile="~/Modelo.master" AutoEventWireup="true" CodeBehind="pesqFrentista.aspx.cs" Inherits="CaveWeb.pesqFrentista" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

  <div>
    <asp:Label ID="Label1" runat="server" CssClass="titulo2" 
      Text="PESQUISA DE FRENTISTA"></asp:Label>
  </div>
  ...
  <table style="width: 100%" class="tabela">
    ...
    <tr>
      ...
      <td style="width: 42px; height: 27px;">
        <asp:TextBox ID="txbRazao_social" runat="server" CssClass="textbox" MaxLength="10" 
...
<HeaderStyle Width="20px"></HeaderStyle>
  ...
  <Columns>
    ...
    <telerik:GridBoundColumn DataField="RAZAO_SOCIAL" HeaderText="Fornecedor / Posto" 
      UniqueName="column3">
    </telerik:GridBoundColumn>
